	...
	function GUI(){
		...
		this.built_in_examples_data = [
				...
				data: { 'equation': '(x+w)^2+y^2+z^2 = 10' }},
			{
				...
				data: { 'points': '(-5.0,-5.0,-5.0,-5.0),(5.0,-5.0,-5.0,-5.0),(-5.0,5.0,-5.0,-5.0),(5.0,5.0,-5.0,-5.0),(-5.0,-5.0,5.0,-5.0),(5.0,-5.0,5.0,-5.0),(-5.0,5.0,5.0,-5.0),(5.0,5.0,5.0,-5.0),(-5.0,-5.0,-5.0,5.0),(5.0,-5.0,-5.0,5.0),(-5.0,5.0,-5.0,5.0),(5.0,5.0,-5.0,5.0),(-5.0,-5.0,5.0,5.0),(5.0,-5.0,5.0,5.0),(-5.0,5.0,5.0,5.0),(5.0,5.0,5.0,5.0)' }},
			{
