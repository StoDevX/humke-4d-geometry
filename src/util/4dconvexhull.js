var ConvexHull4D = (function (scope) {
  ...
  ConvexHull4D.prototype.ConvexHull4D = function(points) {
    ...
    - Each new point is processed in 3 steps:
      1. Locate visible facets for the point. 
         * The boundary of these facets is the horizon ridges for the point.
         * A facet is visible if the point is above the facet.
      2. Construct a cone of new facets from the point to its horizon ridges.
      3. Delete the visible facets, thus forming the convex hull of the new point and the previously processed points
